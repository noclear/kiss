...
module kiss.nio.AsynchronousChannelBase;
...
import kiss.nio.AsynchronousSelectionKey;
import std.socket;
import std.stdio;
...
protected:  
    ...
    void register(int ops, void* handle, void* attchment, ByteBuffer obj = null)
    {
        if (!checkVailid(ops))
            return ;
